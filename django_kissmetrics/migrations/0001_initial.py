...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Events'
        db.create_table('django_kissmetrics_events', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
            ...
            ('identity', self.gf('django.db.models.fields.CharField')(max_length=64, db_index=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
        ))
        db.send_create_signal('django_kissmetrics', ['Events'])

    def backwards(self, orm):
        # Deleting model 'Events'
        db.delete_table('django_kissmetrics_events')
